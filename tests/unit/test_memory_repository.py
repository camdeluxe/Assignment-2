...
def test_repository_can_retrieve_genres(in_memory_repo):
    assert in_memory_repo.get_genres() == {Genre("Fantasy"), Genre("Horror"), Genre("Mystery"), Genre("Action"), Genre("Drama"), Genre("Comedy"), Genre("Music"), Genre("Sci-Fi"), Genre("Animation"), Genre("Family"), Genre("Biography"), Genre("Adventure"), Genre("Romance"), Genre("Thriller")}
